<template>
    <div>
        ...
        <span class="m-1"></span>
        <div
            class="bg-gray-700 container mx-auto px-4 py-4 mb-4 text-4xl font-mono Liberation Mono leading-none tracking-tight text-white font-bold md:text-4xl lg:text-4xl dark:text-white rounded-lg">
            <form class="container mx-auto">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="floating_masukan" id="floating_masukan"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " 
                            v-model="masukan" />
                ...
                <button type="Submit"
                    ...
                    <span
                        class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0" @click="saveFeedback">
                        Submit
                    </span>
                </button>
            </form>
