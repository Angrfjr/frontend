<template>
    <div class="mx-auto">
      <TheNavbar/>
      <h1 class="bg-gray-700 mb-4 text-4xl text-center font-mono Liberation Mono leading-none tracking-tight text-white font-bold px-2 py-1 md:text-4xl lg:text-4xl dark:text-white">List Data Penduduk</h1>
            ...
            <table class="w-full rounded-lg text-sm text-left text-blue-100 dark:text-blue-100">
                <thead class="text-xs text-white uppercase bg-gray-800 border-b border-gray-400 dark:text-white">
                    <tr>
                        ...
                        <th scope="col" class="text-center px-6 py-3">NIK</th>
                ...
                <tbody>
                    <tr class="bg-gray-600 border-b border-gray-400 hover:bg-gray-400" v-for="item in items" :key="item.id">
                        ...
                        <td class="text-center px-6 py-4">{{ item.nik }}</td>
                        <td class="text-center px-6 py-4">{{ item.alamat }}</td>
                        <td class="text-center px-6 py-4">{{ item.status }}</td>
